                ...
                <div className="container relative mx-auto px-4 md:px-6">
                    <AnimatedSection className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground font-light max-w-2xl mx-auto">
                            Building trust through explicit authorization and clear intent.
                        </p>
                    </AnimatedSection>
                </div>
            </section>
                            ...
                            <div className="space-y-8 max-w-2xl">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6 pt-8">
                                    <div className="flex items-center gap-4 bg-card/50 p-6 rounded-xl border border-border/50">
                                        ...
                                        <span className="text-muted-foreground text-left">No action happens automatically.</span>
                                    </div>
                                    <div className="flex items-center gap-4 bg-card/50 p-6 rounded-xl border border-border/50">
                                        <FileCheck className="h-6 w-6 text-primary flex-shrink-0" />
                                        <span className="text-muted-foreground text-left">No responsibility is transferred without confirmation.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
